  ...
  return (
    ...
    <div>
      <nav className='navigationContainer'>
        <a href="https://salemk12.org/" target='_blank' className='navigationLinkStyles'>SPS Main Website</a>

        <a href="" target='_blank' className='navigationLinkStyles'>Talent Ed</a>
      </nav>
